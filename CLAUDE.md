...
كل الصفحات مكتملة. 0 ثغرات (`npm audit`)، البناء نظيف (`tsc + vite`). كل شي مرفوع على GitHub (`main`). ملف الرفع لـManus محدّث: `C:\Users\asus\Desktop\alhimmah-app.zip` (عبر `git archive`).

...
/* عبارات تشجيع قصيرة (تتناوب عشوائياً) — لهجة شبابية تطلع مع كل إنجاز */
const CHEERS = [
  'كفو! 🔥', 'يا بطل 💪', 'ماشاءالله 🌟', 'استمر 🚀', 'خطوة للقمة ⛰️',
  'زادت همّتك ✨', 'تمام التمام 👏', 'تم القصف! 💥', 'مسحتها مسح 🦾',
  'كفو عليك يا ملهم 🔥', 'كفووو 👑', 'ملهم اليوم ⚡', 'اللي بعده 🎯',
];

/* ===================================================================
   ...
   جدول مرن (إضافة بديلة لجدول المدرب سعود، لا بديلاً عنه).
  ...
  return (
    <div className="page">
      ...
      <PageHero
        ...
        subtitle="صمّم عدد الأيام والتمارين التي تناسبك تماماً — بجانب برنامج «المدرب سعود» الجاهز، لا بديلاً عنه."
      />

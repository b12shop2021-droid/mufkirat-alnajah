...
export const WEEKLY_CHALLENGES: WeeklyChallengeDef[] = [
  ...
  { emoji: '🚫', title: '3 أيام بدون تسويف', hint: 'وش رايك نلعب على ثقيل؟ قدها ولا نكنسل؟', reward: 30 },
  { emoji: '😌', title: 'خلّص مهامك قبل العصر', hint: 'تحدي "الروقان المنتج" — اخلص شغلك بدري وعيش باقي يومك وأنت منسدح بضمير مستريح', reward: 30 },
  { emoji: '🏋️', title: 'اخلص من أثقل مهمة مؤجلة عندك', hint: 'شطب على أثقل مهمة مؤجلة من أسبوع.. اخلص منها وفك عمرك!', reward: 30 },
];
